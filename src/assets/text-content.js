...
project2.projectDescription = 'Short description of the project2. Just a couple sentences will do.';
...
project3.projectDescription = 'Short description of the project3. Just a couple sentences will do.';
...
project4.projectDescription = 'Short description of the project4. Just a couple sentences will do.';
...
project5.projectDescription = 'Short description of the project5. Just a couple sentences will do.';
...
project6.projectDescription = 'Requesting data from an API, using asynchronous javascript code.';
project6.screenshotProjectSource = screenshot6;
project6.githubHref = 'https://github.com/manelly67/TheOdinProject-WeatherApp';
project6.projectNewWindow = 'https://manelly67.github.io/TheOdinProject-WeatherApp';
